//
// This is a **build** test - it does nothing else except ensure that all the
// C++ wrapper classes are included and that the program builds.
//
// Once there are demos which exercise all the C++ classes this "test" can be
// removed
//
#include <clocale>
#include <cstdlib>
